...
<template>
  <div>
    ...
    <div v-else-if="store.items.length" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
      <div
    ...
    <div v-else class="card text-center py-16">
      ...
      <p class="text-gray-500 font-medium">No personas defined yet</p>
      <p class="text-xs text-gray-400 mt-1">Create personas to personalize the platform experience</p>
    </div>
  </div>
</template>
